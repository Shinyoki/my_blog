package com.senko.common.utils.stream;
...
public class StreamUtils {
    ...
    public static long copy(InputStream in, OutputStream out) throws IOException {
        return StreamUtils.copy(in, out, StreamUtils.DEFAULT_BUFFER_SIZE);
    }
    ...
    public static long copy(InputStream in, OutputStream out, int bufSize) throws IOException {
        return StreamUtils.copy(in, out, true, new byte[bufSize]);
    }
